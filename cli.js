...
program
    ...
    .description("it runs your awesome web application client")
        ...
        .option("--compression-level <compressionLevel>", "it defines if compress data or not <default " + commonDefaults["compression-level"] + ">")
        .option("--minify", "it defines if minify data or not <default " + commonDefaults.minify + ">")
        .option("--minify-mangle", "it defines if minify data or not <default " + commonDefaults["minify-mangle"] + ">")
